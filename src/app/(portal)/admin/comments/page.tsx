...
export default function CommentsAdminPage() {
  ...
  const displayComments = viewTab === "flagged" ? flaggedComments : comments;
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-800 pb-5">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Audit discussions across gigs and chart entries, triage flagged content, and manage pinned announcements.
          </p>
        </div>
            ...
            >
              <div className="space-y-2.5 flex-1">
                <div className="flex flex-wrap items-center gap-2.5 text-xs">
                  ...
                  <span className="text-slate-400 font-mono text-[11px] bg-slate-950 px-2 py-0.5 rounded border border-slate-800 uppercase">
                    {comment.targetType}: {comment.targetTitle || comment.targetId}
                  </span>
                  <span className="text-slate-500">•</span>
